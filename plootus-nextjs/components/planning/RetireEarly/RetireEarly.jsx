      ...
      <div className={styles.pageBody}>
        ...
        <aside className={styles.sidebar}>
          ...
          <div className={styles.sidebarCard} style={{ background: 'var(--orange-light)', borderColor: 'rgba(232,89,12,.2)' }}>
            <p style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--orange)', marginBottom: '8px' }}>FIRE Formula</p>
            <p style={{ fontSize: '15px', fontWeight: 800, color: 'var(--navy)', lineHeight: 1.4, marginBottom: '8px' }}>Annual Spend ÷ 3.5% = FIRE Number</p>

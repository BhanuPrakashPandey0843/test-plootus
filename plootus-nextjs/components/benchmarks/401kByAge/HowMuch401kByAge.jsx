      ...
      <div className={styles.pageWrap}>
        <main className={styles.main}>
          ...
          <div className={styles.inlineCta}>
            ...
            <a className={styles.ictBtn} href="https://plootus.com/my-dashboard">See My Benchmarks →</a>
          </div>
          ...
          <section id="chart">
            ...
            <div className={styles.chartBox}>
              ...
              <canvas id="benchChart" height="100"></canvas>
          ...
          <div className={`${styles.inlineCta} ${styles.inlineCtaDark}`}>
            ...
            <a className={styles.ictBtn} href="https://plootus.com/my-dashboard">Start Free →</a>
          </div>
        </main>
...
const RelatedBox = () => (
  <div className={styles.relatedBox}>
    ...
    <a href="/403b-guide">→ Average 403(b) Balance by Age</a>
    <a href="/how-to-plan-retirement">→ How to Plan for Retirement</a>
    <a href="/best-states-to-retire-2026">→ Best States to Retire 2026</a>
    <a href="/social-security-when-to-claim">→ Social Security: When to Claim</a>
    <a href="/early-retirement-guide-fire">→ Early Retirement / FIRE Guide</a>
  </div>
);

        ...
        <Box className={`${classes.stepsWrap} reveal d3`}>
          <Box className={classes.stepCard}>
            ...
            <Typography className={classes.stepDesc}>
              Find your 401(k), 403(b), 457, or TSP plan from our database of thousands of U.S. employer plans. Just type your employer name — no login or SSN needed.
            </Typography>
          </Box>
          <Box className={classes.stepCard}>
            ...
            <Typography className={classes.stepDesc}>
              Choose conservative, moderate, or aggressive. Plootus factors in your age, timeline, and savings to calibrate the right allocation for your goals.
            </Typography>
          </Box>
          <Box className={classes.stepCard}>
            ...
            <Typography className={classes.stepDesc}>
              Our AI scans your plan's actual fund lineup and selects the best-performing, lowest-fee options available to you. A personalized portfolio in seconds.
            </Typography>
          </Box>
          <Box className={classes.stepCard}>
            ...
            <Typography className={classes.stepDesc}>
              Link all your accounts for a complete financial picture. Plootus monitors your portfolio and alerts you when your strategy needs adjustment.
            </Typography>
          </Box>
        </Box>
      </Container>

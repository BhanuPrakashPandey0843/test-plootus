...
const useStyles = makeStyles()((theme) => ({
  section: { padding: theme.spacing(4.5, 0), marginBottom: 0 },
  secLabel: {
  ...
  secIntro: {
    fontSize: '0.98rem', color: '#6B7A90', lineHeight: 1.75, maxWidth: 900,
    fontWeight: 400, textAlign: 'center', margin: '0 auto', display: 'block', width: '100%',
  },
  featureRow: {
    display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60,
    alignItems: 'center', marginBottom: 15,
    '&:last-child': { marginBottom: 0 },
    [theme.breakpoints.down('md')]: { gridTemplateColumns: '1fr', gap: 32 },
  },
  reverse: {
    '& $featureVisual': { order: 2, [theme.breakpoints.down('md')]: { order: 1 } },
    '& $featureText': { order: 1, [theme.breakpoints.down('md')]: { order: 2 } },
  },
  featureTag: {
    display: 'inline-block', background: '#EEF2FF', color: '#3B5FDB',
    fontSize: '0.7rem', fontWeight: 700, padding: '3px 11px', borderRadius: 99,
    textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 10,
  },
  greenTag: { background: '#E8F9F0', color: '#2DBE6C' },
  featureText: {
    '& h3': { fontSize: '1.45rem', fontWeight: 800, color: '#1A2B4A', marginBottom: 12, letterSpacing: -0.3, fontFamily: "'Plus Jakarta Sans', sans-serif" },
    '& p': { fontSize: '0.92rem', color: '#6B7A90', lineHeight: 1.78, marginBottom: 12, '& strong': { color: '#1A2B4A' } },
  },
  featureVisual: {
    borderRadius: 16, overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center',
    [theme.breakpoints.down('md')]: { height: 280 },
  },
  visualContainer: {
    width: '100%', aspectRatio: '1.4 / 1', position: 'relative',
    padding: theme.spacing(1), border: '2px solid rgba(226,232,240,0.3)',
    borderRadius: 20, background: 'rgba(255,255,255,0.05)',
  },
  visualInner: {
    width: '100%', height: '100%', background: '#F5F7FD', borderRadius: 14,
    padding: theme.spacing(8), border: '1px solid rgba(226,232,240,0.6)',
  ...
  return (
    <section className={classes.section}>
      <Container maxWidth="lg" style={{ textAlign: 'center' }}>
        ...
        <Typography variant="h2" className={`${classes.title} reveal d1`}>Built to make your money work harder</Typography>
        ...
        <Box className={`${classes.featureRow} ${classes.reverse} reveal d3`}>
          <Box className={classes.featureText}>
            ...
            <Typography component="p">Effortlessly locate your 401(k), 403(b), 457, or TSP plan — just enter your employer's name and Plootus delivers tailored investment recommendations within seconds.</Typography>
            <Typography component="p">Our algorithm analyzes your plan's complete fund lineup and maps the best options to your <strong>specific risk profile and retirement timeline</strong>.</Typography>
        ...
        <Box className={`${classes.featureRow} reveal d3`}>
          ...
          <Box className={classes.featureText}>
            ...
            <Typography component="p">Effortlessly manage all your finances in one place. Plootus links your accounts, giving you real-time updates on your checking, savings, credit card, and investment account balances.</Typography>
        ...
        <Box className={`${classes.featureRow} ${classes.reverse} reveal d3`}>
          <Box className={classes.featureText}>
            ...
            <Typography component="p">Take the guesswork out of retirement. Plootus's AI-driven retirement calculator offers savings projections, strategic suggestions, and helps you adjust contributions to meet your goals.</Typography>
            <Typography component="p">Tell us your target retirement year, expected expenses, and current savings. Plootus models your precise path — <strong>how much to contribute, when you can retire, and what income you will be able to sustain</strong>.</Typography>
